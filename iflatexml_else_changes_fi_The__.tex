...
\begin{equation}
d_W(N(\mu_1, \P_1),N(\mu_2, \P_2)) = |\mu_1 -\mu_2|^2 + \tr \P_1 + \tr \P_2 - 2 \tr \left( \left( \P_1^{1/2} \P_2 \P_1^{1/2} \right)^{1/2} \right) \ .
\label{eq:dist_wass}
\end{equation}
Since means are null in our case, the Wasserstein distance is:
\begin{equation}
d_W(N(\mu_X, \Sigma_X),N(\mu_Y, \Sigma_Y)) = \tr \P_1 + \tr \P_2 - 2 \tr \left( \left( \P_1^{1/2} \P_2 \P_1^{1/2} \right)^{1/2} \right) \ .
