...
In this step, outliers matrices are removed to have a reliable mean estimation using Algorithm~\ref{alg:center_estimation} (TODO: with a z-score threshold $z_{th} = 2.5$ and a number of iterations $L=2$) \cite{barachant2013riemannian}.
